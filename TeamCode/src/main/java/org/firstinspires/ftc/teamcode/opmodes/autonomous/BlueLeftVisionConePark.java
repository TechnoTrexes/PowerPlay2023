...
@Autonomous(name="BlueLeftVisionConePark", group="Linear Opmode")

public class BlueLeftVisionConePark extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            driveTrain.driveDistance(0.8, 29, 270, false); // was 4
